...
Panel {
  ...
  component Meter: Item {
    ...
    property real thickness: Math.max(Style.space(4), Math.round(Style.spacing.controlHeight * 0.22))
  ...
  component DayRow: Item {
    ...
    Rectangle {
      ...
      anchors.verticalCenter: parent.verticalCenter
      height: Math.max(Style.space(4), Math.round(Style.spacing.controlHeight * 0.22))
      radius: height / 2
      color: root.track
      ...
      Rectangle {
        ...
        color: dayRow.today ? root.foreground : root.alpha(root.foreground, 0.72)
